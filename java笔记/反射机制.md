...
1、 `Class.getField(String name)` 和 `Class.getFields()`

>只能获取 public 修饰的字段，包括继承来的 public 字段，不包括 private / protected 字段

```java
Field field = SomeClass.class.getField("publicField"); // 仅限 public
Field[] fields = SomeClass.class.getFields(); // 所有 public 字段
```