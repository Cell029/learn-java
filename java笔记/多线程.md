...
>每个线程都有一个boolean标识，代表着是否有中断请求（该请求可以来自所有线程，包括被中断的线程本身）
...
>检测当前线程的中断状态，并重置该状态（即清除中断标志，设置为 `false`）

![](images/多线程/file-20250505211740.png)

![](images/多线程/file-20250505210704.png)

>`Thread.interrupt()` 是一个 static 方法，所以它只适用于当前正在运行的线程

![](images/多线程/file-20250505212320.png)