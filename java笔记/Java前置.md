...
![](images/Java前置/file-20250402174751.png)
...
![](images/Java前置/file-20250402182259.png)

![](images/Java前置/file-20250402182632.png)
...
![](images/Java前置/3a519eb6fe334c083fdbffd05b72a1c6.png)

>出现版本号证明安装成功,接下来要配置环境变量,方便idea自动查找jdk

![](images/Java前置/aed317d832ddf19b1b34ee3b99bc6d97.png)

![](images/Java前置/64452656e7204bd5e98eac624fadd52b.png)

>环境变量配置成功后,直接输入命令就可以使用了.

![](images/Java前置/fe2d4f4ab645e957c94902e99f224930.png)