...
```sql
select year,
sum(case when season = '一季度' then count else 0 end) as 一季度,
sum(case when season = '二季度' then count else 0 end) as 二季度,
sum(case when season = '三季度' then count else 0 end) as 三季度,
sum(case when season = '四季度' then count else 0 end) as 四季度
from T_TEMP group by year;
```
